	...
	<div class="tab-content">
		<div class="tab-pane active" id="tab-general">
			...
			<div class="col-md-12">
				...
				<div class="form-group">
					<label class="col-md-2 control-label" for="confirm">{{
						trans('admin/users.role') }}</label>
					<div class="col-md-6">
						<select class="form-control" name="admin" id="admin">
                                                        <option value="3" {{{ ((isset($user) && $user->admin == 3) ?
								' selected="selected"' : '') }}}>{{{ trans('admin/users.admin_3')
								}}}</option>
							<option value="2" {{{ ((isset($user) && $user->admin == 2) ?
								' selected="selected"' : '') }}}>{{{ trans('admin/users.admin_2')
								}}}</option>
                                                        <option value="1" {{{ ((isset($user) && $user->admin == 1)? '
								selected="selected"' : '') }}}>{{{ trans('admin/users.admin_1')
								}}}</option>
